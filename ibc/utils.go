...
import (
	...
	"github.com/lyfeblocnetwork/os/utils"
...
func GetTransferSenderRecipient(data transfertypes.FungibleTokenPacketData) (
	...
	// and change the bech32 human readable prefix (HRP) of the sender to `lyfebloc`
	...
	// and change the bech32 human readable prefix (HRP) of the recipient to `lyfebloc`
