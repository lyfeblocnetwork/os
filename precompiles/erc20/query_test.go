...
import (
	...
	chainutil "github.com/lyfeblocnetwork/os/example_chain/testutil"
	...
	app "github.com/lyfeblocnetwork/os/example_chain"
...
var (
	...
	validAttoTraceDenom = types.DenomTrace{Path: "channel-0", BaseDenom: "alyfebloc"}
	// validTraceDenomNoMicroAtto is a denomination trace with a valid IBC voucher name but no micro or atto prefix
	validTraceDenomNoMicroAtto = types.DenomTrace{Path: "channel-0", BaseDenom: "mlyfebloc"}
