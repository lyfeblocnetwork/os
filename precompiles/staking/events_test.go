...
func (s *PrecompileTestSuite) TestIncreaseAllowanceEvent() {
	...
	testCases := []struct {
		...
		{
			"success - increased allowance for all 3 methods by 1 lyfebloc",
			func(grantee common.Address) []interface{} {
				return []interface{}{
					grantee,
...
func (s *PrecompileTestSuite) TestDecreaseAllowanceEvent() {
	...
	testCases := []struct {
		...
		{
			"success - decreased allowance for all 3 methods by 1 lyfebloc",
			func(grantee common.Address) []interface{} {
				return []interface{}{
					grantee,
					big.NewInt(1000000000000000000),
