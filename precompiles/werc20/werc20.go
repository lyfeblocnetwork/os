...
import (
	...
	erc20 "github.com/lyfeblocnetwork/os/precompiles/erc20"
...
func (p Precompile) RequiredGas(input []byte) uint64 {
	// TODO: these values were obtained from Remix using the LBT9.sol.
	// We should execute the transactions from Lyfebloc testnet
