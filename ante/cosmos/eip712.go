...
var lyfeblocCodec codec.ProtoCodecMarshaler

func init() {
	registry := codectypes.NewInterfaceRegistry()
	types.RegisterInterfaces(registry)
	lyfeblocCodec = codec.NewProtoCodec(registry)
}
...
func VerifySignature(
	...
	case *signing.SingleSignatureData:
		...
		typedData, err := eip712.LegacyWrapTxToTypedData(lyfeblocCodec, extOpt.TypedDataChainID, msgs[0], txBytes, feeDelegation)
		if err != nil {
