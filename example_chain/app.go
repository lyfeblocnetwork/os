...
import (
	...
	lyfeblocante "github.com/lyfeblocnetwork/os/ante"
	lyfeblocevmante "github.com/lyfeblocnetwork/os/ante/evm"
	lyfeblocencoding "github.com/lyfeblocnetwork/os/encoding"
	chainante "github.com/lyfeblocnetwork/os/example_chain/ante"
	srvflags "github.com/lyfeblocnetwork/os/server/flags"
	lyfebloctypes "github.com/lyfeblocnetwork/os/types"
	lyfeblocutils "github.com/lyfeblocnetwork/os/utils"
	"github.com/lyfeblocnetwork/os/x/erc20"
	erc20keeper "github.com/lyfeblocnetwork/os/x/erc20/keeper"
	erc20types "github.com/lyfeblocnetwork/os/x/erc20/types"
	"github.com/lyfeblocnetwork/os/x/evm"
	"github.com/lyfeblocnetwork/os/x/evm/core/vm"
	evmkeeper "github.com/lyfeblocnetwork/os/x/evm/keeper"
	evmtypes "github.com/lyfeblocnetwork/os/x/evm/types"
	"github.com/lyfeblocnetwork/os/x/feemarket"
	feemarketkeeper "github.com/lyfeblocnetwork/os/x/feemarket/keeper"
	feemarkettypes "github.com/lyfeblocnetwork/os/x/feemarket/types"
	"github.com/spf13/cast"

	// NOTE: override ICS20 keeper to support IBC transfers of ERC20 tokens
	"github.com/lyfeblocnetwork/os/x/ibc/transfer"
	transferkeeper "github.com/lyfeblocnetwork/os/x/ibc/transfer/keeper"

	// Force-load the tracer engines to trigger registration due to Go-Ethereum v1.10.15 changes
	_ "github.com/lyfeblocnetwork/os/x/evm/core/tracers/js"
	_ "github.com/lyfeblocnetwork/os/x/evm/core/tracers/native"
)

func init() {
	// manually update the power reduction by replacing micro (u) -> atto (a) lyfebloc
	sdk.DefaultPowerReduction = lyfebloctypes.AttoPowerReduction
...
func NewExampleApp(
	...
	encodingConfig := lyfeblocencoding.MakeConfig()
	...
	// initialize the Lyfebloc application configuration
	...
	*/
	...
	// NOTE: we are adding all available Lyfebloc EVM extensions.
...
func (app *ExampleChain) setAnteHandler(txConfig client.TxConfig, maxGasWanted uint64) {
	options := chainante.HandlerOptions{
		...
		ExtensionOptionChecker: lyfebloctypes.HasDynamicFeeExtensionOption,
		EvmKeeper:              app.EVMKeeper,
		FeegrantKeeper:         app.FeeGrantKeeper,
		IBCKeeper:              app.IBCKeeper,
		FeeMarketKeeper:        app.FeeMarketKeeper,
		SignModeHandler:        txConfig.SignModeHandler(),
		SigGasConsumer:         lyfeblocante.SigVerificationGasConsumer,
		MaxTxGasWanted:         maxGasWanted,
		TxFeeChecker:           lyfeblocevmante.NewDynamicFeeChecker(app.FeeMarketKeeper),
	}
...
func (app *ExampleChain) InitChainer(ctx sdk.Context, req *abci.RequestInitChain) (*abci.ResponseInitChain, error) {
	var genesisState lyfebloctypes.GenesisState
...
//   - Lyfebloc' available static precompiled contracts
func BlockedAddresses() map[string]bool {
	...
	for _, precompile := range blockedPrecompilesHex {
		blockedAddrs[lyfeblocutils.EthHexToCosmosAddr(precompile).String()] = true
	}
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	// TODO: do we need a keytable? copied from Lyfebloc repo
