...
if [[ $overwrite == "y" || $overwrite == "Y" ]]; then
	...
	osd genesis add-genesis-account "$VAL_KEY" 100000000000000000000000000alyfebloc --keyring-backend "$KEYRING" --home "$HOMEDIR"
	osd genesis add-genesis-account "$USER1_KEY" 1000000000000000000000alyfebloc --keyring-backend "$KEYRING" --home "$HOMEDIR"
	osd genesis add-genesis-account "$USER2_KEY" 1000000000000000000000alyfebloc --keyring-backend "$KEYRING" --home "$HOMEDIR"
	osd genesis add-genesis-account "$USER3_KEY" 1000000000000000000000alyfebloc --keyring-backend "$KEYRING" --home "$HOMEDIR"
	osd genesis add-genesis-account "$USER4_KEY" 1000000000000000000000alyfebloc --keyring-backend "$KEYRING" --home "$HOMEDIR"

	# Sign genesis transaction
	osd genesis gentx "$VAL_KEY" 1000000000000000000000alyfebloc --gas-prices ${BASEFEE}alyfebloc --keyring-backend "$KEYRING" --chain-id "$CHAINID" --home "$HOMEDIR"
