...
func SubmitProposal(
	ctx sdk.Context,
	appLyfebloc *exampleapp.ExampleChain,
	...
	res, err := DeliverTx(ctx, appLyfebloc, pk, nil, msg)
	if err != nil {
		return id, err
	}
...
func Delegate(
	...
	return DeliverTx(ctx, appLyfebloc, priv, nil, delegateMsg)
}
...
func Vote(
	...
	return DeliverTx(ctx, appLyfebloc, priv, nil, voteMsg)
}
