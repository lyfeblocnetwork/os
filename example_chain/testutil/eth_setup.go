...
// EthSetup initializes a new Lyfebloc application. A Nop logger is set in ExampleChain.
func EthSetup(isCheckTx bool, chainID string, patchGenesis func(*exampleapp.ExampleChain, lyfebloctypes.GenesisState) lyfebloctypes.GenesisState) *exampleapp.ExampleChain {
...
func EthSetupWithDB(isCheckTx bool, chainID string, patchGenesis func(*exampleapp.ExampleChain, lyfebloctypes.GenesisState) lyfebloctypes.GenesisState, db dbm.DB) *exampleapp.ExampleChain {
...
func NewTestGenesisState(app *exampleapp.ExampleChain) lyfebloctypes.GenesisState {
	privVal := mock.NewPV()
...
func genesisStateWithValSet(codec codec.Codec, genesisState lyfebloctypes.GenesisState,
	valSet *cmtypes.ValidatorSet, genAccs []authtypes.GenesisAccount,
	balances ...banktypes.Balance,
) lyfebloctypes.GenesisState {
