...
// PreprocessLedgerTx reformats Ledger-signed Cosmos transactions to match the fork expected by Lyfebloc
...
func PreprocessLedgerTx(chainID string, keyType cosmoskr.KeyType, txBuilder client.TxBuilder) error {
	...
	// (Regardless of input signMode, Lyfebloc requires Amino signature type for Ledger)
