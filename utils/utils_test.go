...
func TestGetAccAddressFromBech32(t *testing.T) {
	...
	config.SetBech32PrefixForAccount("lyfebloc", "lyfeblocpub")
	...
	testCases := []struct {
		...
		{
			"lyfebloc address",
			"lyfebloc1qql8ag4cluz6r4dz28p3w00dnc9w8ueuafmxps",
			"lyfebloc1qql8ag4cluz6r4dz28p3w00dnc9w8ueuafmxps",
			false,
		},
		{
...
func TestLyfeblocCoinDenom(t *testing.T) {
	testCases := []struct {
		name     string
		denom    string
		expError bool
...
func TestAddressConversion(t *testing.T) {
	...
	bech32 := "lyfebloc10jmp6sgh4cc6zt3e8gw05wavvejgr5pwjnpcky"
