...
import (
	...
	"github.com/lyfeblocnetwork/os/ethereum/eip712"
	"github.com/lyfeblocnetwork/os/wallets/accounts"
	"github.com/lyfeblocnetwork/os/wallets/usbwallet"
)
...
func LyfeblocLedgerDerivation() Secp256k1DerivationFn {
	lyfeblocSECP256K1 := new(LyfeblocSECP256K1)

	return func() (sdkledger.SECP256K1, error) {
		return lyfeblocSECP256K1.connectToLedgerApp()
	}
}

var _ sdkledger.SECP256K1 = &LyfeblocSECP256K1{}

// LyfeblocSECP256K1 defines a wrapper of the Ethereum App to
// for compatibility with Cosmos SDK chains.
type LyfeblocSECP256K1 struct {
	*usbwallet.Hub
...
func (e LyfeblocSECP256K1) Close() error {
...
func (e LyfeblocSECP256K1) GetPublicKeySECP256K1(hdPath []uint32) ([]byte, error) {
	if e.PrimaryWallet == nil {
...
// GetAddressPubKeySECP256K1 takes in the HD path as well as a "Human Readable Prefix" (HRP, e.g. "lyfebloc")
// to return the public key bytes in secp256k1 format as well as the account address.
func (e LyfeblocSECP256K1) GetAddressPubKeySECP256K1(hdPath []uint32, hrp string) ([]byte, string, error) {
	if e.PrimaryWallet == nil {
...
func (e LyfeblocSECP256K1) SignSECP256K1(hdPath []uint32, signDocBytes []byte, _ byte) ([]byte, error) {
...
func (e LyfeblocSECP256K1) displayEIP712Hash(typedData apitypes.TypedData) error {
...
func (e *LyfeblocSECP256K1) connectToLedgerApp() (sdkledger.SECP256K1, error) {
