...
import (
	...
	"github.com/lyfeblocnetwork/os/wallets/ledger"
	"github.com/lyfeblocnetwork/os/wallets/ledger/mocks"
...
type LedgerTestSuite struct {
	...
	txAmino    []byte
	txProtobuf []byte
	ledger     ledger.LyfeblocSECP256K1
...
func (suite *LedgerTestSuite) SetupTest() {
	...
	suite.ledger = ledger.LyfeblocSECP256K1{Hub: hub, PrimaryWallet: mockWallet}
}
	...
	tmp := whitespaceRegex.ReplaceAllString(fmt.Sprintf(
		`{
			...
			"msgs":[{
				...
				"value":{
					"amount":[{"amount":"150","denom":"atom"}],
					"from_address":"lyfebloc10jmp6sgh4cc6zt3e8gw05wavvejgr5pwjnpcky",
					"to_address":"lyfebloc1fx944mzagwdhx0wz7k9tfztc8g3lkfk6rrgv6l"
				}
			}],
			"sequence":"6"
...
func (suite *LedgerTestSuite) getMockTxProtobuf() []byte {
	...
	msg := bankTypes.NewMsgSend(
		sdk.MustAccAddressFromBech32("lyfebloc1r5sckdd808qvg7p8d0auaw896zcluqfduvr8nf"),
		sdk.MustAccAddressFromBech32("lyfebloc10t8ca2w09ykd6ph0agdz5stvgau47whhlfe3l4"),
		[]sdk.Coin{
			{
				Denom:  "atom",
