...
HTTPS_GIT := https://github.com/lyfeblocnetwork/os.git
...
PACKAGE_NAME:=github.com/lyfeblocnetwork/os
...
# Lyfebloc repository and then clean up the contracts data.
...
# Compile the solidity contracts found in the Lyfebloc repository.
contracts-compile:
...
check-licenses:
	...
	@curl -sSfL https://raw.githubusercontent.com/lyfeblocnetwork/lyfebloc/v19.0.0/scripts/license_checker/check_licenses.py -o check_licenses.py
