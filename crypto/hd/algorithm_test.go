...
import (
	...
	cryptocodec "github.com/lyfeblocnetwork/os/crypto/codec"
	enccodec "github.com/lyfeblocnetwork/os/encoding/codec"
...
func TestKeyring(t *testing.T) {
	...
	kr, err := keyring.New("lyfebloc", keyring.BackendTest, dir, mockIn, TestCodec, EthSecp256k1Option())
	...
	info, mnemonic, err := kr.NewMnemonic("foo", keyring.English, lyfebloctypes.BIP44HDPath, keyring.DefaultBIP39Passphrase, EthSecp256k1)
	require.NoError(t, err)
	...
	hdPath := lyfebloctypes.BIP44HDPath
...
func TestDerivation(t *testing.T) {
	bz, err := EthSecp256k1.Derive()(mnemonic, keyring.DefaultBIP39Passphrase, lyfebloctypes.BIP44HDPath)
	require.NoError(t, err)
	require.NotEmpty(t, bz)
	...
	path := MustParseDerivationPath(lyfebloctypes.BIP44HDPath)
	account, err := wallet.Derive(path, false)
	require.NoError(t, err)
	...
	// Equality of Lyfebloc implementation
	...
	// Equality of Eth and Lyfebloc implementation
	...
	// Inequality of wrong derivation path of Eth and Lyfebloc implementation
