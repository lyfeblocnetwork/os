...
func TestParseChainID(t *testing.T) {
	testCases := []struct {
		...
		{
			"valid chain-id, single digit", "lyfebloc_1-1", false, big.NewInt(1),
		},
		{
		...
		{
			"invalid chain-id, uppercases", "LYFEBLOC_1-1", true, nil,
		},
		{
			"invalid chain-id, mixed cases", "Lyfebloc_1-1", true, nil,
		},
		{
			"invalid chain-id, special chars", "$&*#!_1-1", true, nil,
		},
		{
			"invalid eip155 chain-id, cannot start with 0", "lyfebloc_001-1", true, nil,
		},
		{
			"invalid eip155 chain-id, cannot invalid base", "lyfebloc_0x212-1", true, nil,
		},
		{
			"invalid eip155 chain-id, non-integer", "lyfebloc_lyfebloc_1775-1", true, nil,
		},
		{
			"invalid epoch, undefined", "lyfebloc_-", true, nil,
		},
		{
		...
		{
			"long chain-id", "lyfebloc_" + strings.Repeat("1", 45) + "-1", true, nil,
		},
	}
