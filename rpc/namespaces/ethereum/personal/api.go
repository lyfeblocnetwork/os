...
func (api *PrivateAccountAPI) NewAccount(password string) (common.Address, error) {
	...
	api.logger.Info("Please backup your key file!", "path", os.Getenv("HOME")+"/.lyfebloc/"+name) // TODO: pass the correct binary
...
// Unpair deletes a pairing between wallet and Lyfebloc.
