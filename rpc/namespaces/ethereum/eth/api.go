...
// The Ethereum API allows applications to connect to an node of any Lyfebloc based blockchain.
...
// GasPrice returns the current gas price based on Lyfebloc's gas price oracle.
