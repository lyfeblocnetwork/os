...
func (b *Backend) Resend(args evmtypes.TransactionArgs, gasPrice *hexutil.Big, gasLimit *hexutil.Uint64) (common.Hash, error) {
	...
	for _, tx := range pending {
		// FIXME does Resend api possible at all?  https://github.com/lyfebloc/ethermint/issues/905
...
// GasPrice returns the current gas price based on Lyfebloc' gas price oracle.
