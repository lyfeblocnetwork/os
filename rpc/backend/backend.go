...
type EVMBackend interface {
	...
	GetTxByEthHash(txHash common.Hash) (*lyfebloctypes.TxResult, error)
	GetTxByTxIndex(height int64, txIndex uint) (*lyfebloctypes.TxResult, error)
...
type Backend struct {
	...
	indexer             lyfebloctypes.EVMTxIndexer
}
...
func NewBackend(
	...
	chainID, err := lyfebloctypes.ParseChainID(clientCtx.ChainID)
	if err != nil {
		panic(err)
	}
