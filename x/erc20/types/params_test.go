...
func (suite *ParamsTestSuite) TestParamsValidate() {
	testCases := []struct {
		...
		},
		{
			...
			func() types.Params {
				return types.NewParams(true, []string{}, []string{testconstants.LBTContractMainnet})
			},
			false,
			"",
		},
		{
			...
			func() types.Params {
				return types.NewParams(true, []string{testconstants.LBTContractMainnet}, []string{})
			},
			false,
			"",
		},
		{
			...
			func() types.Params {
				return types.NewParams(true, []string{testconstants.LBTContractTestnet, testconstants.LBTContractMainnet}, []string{})
			},
			false,
			"",
		},
		{
			...
			// order of creation shouldn't matter since it should be sorted when defining new param
			func() types.Params {
				return types.NewParams(true, []string{testconstants.LBTContractMainnet, testconstants.LBTContractTestnet}, []string{})
			},
			false,
			"",
		},
		...
		},
		{
			...
			func() types.Params {
				return types.NewParams(true, []string{testconstants.LBTContractMainnet}, []string{testconstants.LBTContractMainnet})
			},
			true,
		...
		},
		{
			...
			func() types.Params {
				return types.NewParams(true, []string{testconstants.LBTContractMainnet, testconstants.LBTContractMainnet}, []string{})
			},
			true,
			"duplicate precompile",
		},
		{
			...
			func() types.Params {
				return types.NewParams(true, []string{}, []string{testconstants.LBTContractMainnet, testconstants.LBTContractMainnet})
			},
			true,
			"duplicate precompile",
		},
		...
		},
		{
			...
			func() types.Params {
				...
				params.NativePrecompiles = []string{testconstants.LBTContractTestnet, testconstants.LBTContractMainnet}
				return params
			},
			true,
...
func (suite *ParamsTestSuite) TestIsNativePrecompile() {
	testCases := []struct {
	...
	}{
		{
			...
			common.HexToAddress(testconstants.LBTContractMainnet),
			true,
		},
		{
		...
		},
		{
			...
			common.HexToAddress(testconstants.LBTContractTestnet),
			true,
		},
		{
