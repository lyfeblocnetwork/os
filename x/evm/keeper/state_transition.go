...
import (
	...
	lyfebloccore "github.com/lyfeblocnetwork/os/x/evm/core/core"
...
// RANDAO implementation. See https://github.com/lyfebloc/ethermint/pull/1520#pullrequestreview-1200504697
...
func (k *Keeper) NewEVM(
	...
	blockCtx := vm.BlockContext{
		CanTransfer: lyfebloccore.CanTransfer,
		Transfer:    lyfebloccore.Transfer,
		GetHash:     k.GetHashFn(ctx),
		Coinbase:    cfg.CoinBase,
		GasLimit:    lyfebloctypes.BlockGasLimit(ctx),
	...
	txCtx := lyfebloccore.NewEVMTxContext(msg)
	if tracer == nil {
...
func (k Keeper) GetHashFn(ctx sdk.Context) vm.GetHashFunc {
	return func(height uint64) common.Hash {
		h, err := lyfebloctypes.SafeInt64(height)
		if err != nil {
...
func (k *Keeper) ApplyMessageWithConfig(
	...
	// for more info https://github.com/lyfebloc/ethermint/issues/1085
