...
import (
	...
	testfactory "github.com/lyfeblocnetwork/os/testutil/integration/os/factory"
	testhandler "github.com/lyfeblocnetwork/os/testutil/integration/os/grpc"
	testkeyring "github.com/lyfeblocnetwork/os/testutil/integration/os/keyring"
	testnetwork "github.com/lyfeblocnetwork/os/testutil/integration/os/network"
	"github.com/lyfeblocnetwork/os/x/evm"
	"github.com/lyfeblocnetwork/os/x/evm/statedb"
	"github.com/lyfeblocnetwork/os/x/evm/types"
...
func TestExportGenesis(t *testing.T) {
	...
	require.Len(t, genState.Accounts, 3, "expected 3 smart contracts in the exported genesis") // NOTE: 2 deployed above + 1 for the alyfebloc denomination ERC-20 pair
	...
	require.Contains(t, genAddresses, testconstants.LBTContractMainnet, "expected mainnet alyfebloc contract address in exported genesis")
}
