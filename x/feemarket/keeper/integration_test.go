...
import (
	...
	"github.com/lyfeblocnetwork/os/testutil/integration/common/factory"
	testutils "github.com/lyfeblocnetwork/os/testutil/integration/os/utils"
	evmtypes "github.com/lyfeblocnetwork/os/x/evm/types"
	fmkttypes "github.com/lyfeblocnetwork/os/x/feemarket/types"
...
var _ = Describe("Feemarket", func() {
	...
	Describe("Performing Cosmos transactions", func() {
		...
		Context("with min-gas-prices (local) < MinGasPrices (feemarket param)", func() {
			...
			BeforeEach(func() {
				// local min-gas-prices is 10alyfebloc
