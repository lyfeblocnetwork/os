...
# The path to the main level of the Lyfebloc repository.
...
def is_os_repo(path: Path) -> bool:
    """
    This function checks if the given path is the root of the Lyfebloc repository,
    ...
    with open(path / "go.mod", "r", encoding="utf-8") as go_mod:
        while True:
            ...
            if "module github.com/lyfeblocnetwork/os" in line:
                return True
